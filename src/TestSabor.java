...
public class TestSabor {
    public static void main(String[] args){
        Pastel pastel = new Pastel("Vainilla", 100);
        ...
        PastelFiestaCumple pastelFiestaCumple = new PastelFiestaCumple("Chocolate", 200, 6);
        ...
        PastelBoda pastelBoda = new PastelBoda("chocolate", 300, 4);
